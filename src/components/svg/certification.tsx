...
const Certification: React.FC<React.SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => {
  return (
    <svg
      ...
      role="img"
      x-artist="Katerina Limpitsouni"
      x-source="https://undraw.co/"
      className={cn("h-auto w-auto", className)}
      {...props}
    >
      <title>Illustration by Katerina Limpitsouni</title>
